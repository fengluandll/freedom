...
public class SubmenuBean {
	...
	public SubmenuBean(Integer id_menu, Integer id_submenu, String nombre, String descripcion, String url,
			String segment1, String segment2, String segment3, String segment4, String segment5, String segment6,
	...
	public SubmenuBean(Integer id_menu, Integer id_submenu, String nombre, String url) {
		super();
		this.id_menu = id_menu;
		this.id_submenu = id_submenu;
		this.nombre = nombre;
