			...
			click : function() {
				if($("#CPForm_DlgApoderados_txt_poder").val().trim().length>0){
					...
					switch (tipoDeLlenadoDePoder) {
						...
						var tieneMancomunados = $("#CPForm_DlgApoderadosOtros_ApodA").is(":checked");								
                        var listaMancoumandos = $("#CPForm_DlgApoderadosOtros_grid_A").jGridContentMVC_ToString('value', '<BR/>','&#9679;');
