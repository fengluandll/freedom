...
<%
	{
		...
		if(idCatalogoPoderes.equals("0")){
			elems = new DetailApoderados().getApoderadosReporteDefaultRev(idEmpresa, lstNumTipoPoder, lstEscritura,idCatalogoPoderes);
		}else{
			elems = new DetailApoderados().getApoderadosReporteRev(idEmpresa, lstNumTipoPoder, lstEscritura,idCatalogoPoderes);	
		}
