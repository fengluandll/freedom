...
public class FlexColumn {
	...
	private final static Logger log = Logger.getLogger(FlexColumn.class);
	...
	public String ATRIBUTO6; //ULR bandera para ocultar campos status reformas
	  ...
	  */
	  ...
	  public FlexColumn(String COD_FLEX_COLUM) {
	  ...
	  @Override
		public boolean equals(Object obj) {
			...
			return this.COD_FLEX_COLUM.equals(((FlexColumn) obj).COD_FLEX_COLUM);
		}
	  
	  
	  
		public FlexColumn(ResultSet set, ResultSetMetaData metaData) throws Exception {

			ReflexionUtil.fillObject(set, metaData, this, FlexColumn.class);
		}
		

		
		public static ArrayList<FlexColumn> getFlexColumns(String strIdFlexTbl, boolean tbIsHorizontal, boolean modoConfiguracioDeReportes) {
		...
		/*
		public static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl, ConnectionWrapper connect) {
			
			return getFlexColumns(idFlexTbl, connect, false);
		}
		
		public static ArrayList<FlexColumn> getSelectedFlexColumns(int  idFlexTbl, ConnectionWrapper connect, boolean consultaGeneral, String otherCondition) {
		...
		public static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl, ConnectionWrapper connect, boolean consultaGeneral) {
		...
		public static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl, ConnectionWrapper connect, boolean consultaGeneral, HttpServletRequest request) {
		...
		private static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl, String otherCondition, ConnectionWrapper connect, boolean consultaGeneral, String idEmpresa) {
			
			return getFlexColumns(idFlexTbl, connect, consultaGeneral, idEmpresa, otherCondition);
		}
		

		private static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl, ConnectionWrapper connect, boolean consultaGeneral, String idEmpresa) {
		...
		public static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl, ConnectionWrapper connect, 
			...
			ArrayList<FlexColumn> flexColumns = new ArrayList<FlexColumn>();
			ResultSet set = null;
			...
			try {
				...
				int isCS = EstructuraCapitalSocial.isAsociacionCivil(Integer.parseInt(idEmpresa));//JJAQ
				...
				while (set.next()) {
					FlexColumn newFlexColum = new FlexColumn(set, set.getMetaData());
				...
				if(idFlexTbl == 7 && !modoConfiguracioDeReportes) {
					...
					EstructuraCapitalSocial ecs = new EstructuraCapitalSocial(connect, idEmpresa);
		...
		public static ArrayList<FlexColumn> getFlexColumns(
				int  idFlexTbl
		...
		public static ArrayList<FlexColumn> getFlexColumns(int  idFlexTbl
				, ConnectionWrapper connect, 
				boolean consultaResumen, 
				HttpServletRequest request,
				String idEmpresa,
		...
		public static FlexColumn getFlexColumn(int  id, ConnectionWrapper connect) {
			...
			try {
				...
				while (set.next()) {
					...
					return new FlexColumn(set, set.getMetaData());
				}
		...
		public static ArrayList<FlexColumn> getFlexColumnsExcel(int  idFlexTbl, ConnectionWrapper connect, 
                boolean consultaResumen, 
                HttpServletRequest request,
                String idEmpresa, 
                String otherCondition,
