...
public class ReporteAdmVigField {
	...
	final static Logger log = Logger.getLogger(ReporteAdmVigField.class);
	

	public ReporteAdmVigField(ResultSet set, ResultSetMetaData metaData) throws Exception {

		ReflexionUtil.fillObject(set, metaData, this, ReporteAdmVigField.class);
	}

	
	public static ArrayList<ReporteAdmVigField> getFields(int idSeccionRow, ConnectionWrapper connect,int idEmpresa) {

		ArrayList<ReporteAdmVigField> rows = new ArrayList<ReporteAdmVigField>();
		...
		try {
			...
			while (set.next()) {
				...
				rows.add(new ReporteAdmVigField(set, set.getMetaData()));
			}
	...
	public static ReporteAdmVigField getFieldById(String idCampo) {
		...
		try {
			...
			while (set.next()) {
				...
				return new ReporteAdmVigField(set, set.getMetaData());
			}
