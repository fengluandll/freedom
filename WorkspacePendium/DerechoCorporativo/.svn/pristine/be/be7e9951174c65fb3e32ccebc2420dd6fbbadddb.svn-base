...
public class ReporteECSEstructuraCapitalSocial {
...
public static int ECS_FLEX_TABLE_ID = 7;
	...
	public ReporteECSEstructuraCapitalSocial(ConnectionWrapper conn, String idEmpresa) {
	 ...
	 * 
	 */
	public ArrayList<ReporteECSFlexColumn> customizeFlexColumns(ArrayList<ReporteECSFlexColumn> flexColumns) {
	 ...
	 * 
	 */
	public ArrayList<ReporteECSFlexColumn> customizeFlexColumns(ArrayList<ReporteECSFlexColumn> flexColumns, boolean modoConfiguracioDeReportes) {
		
		ArrayList<ReporteECSFlexColumn> newFlexColumnsList = new ArrayList<ReporteECSFlexColumn>(); 
	...
	public static StringBuilder getTableSubHeader(ArrayList<ReporteECSFlexColumn> flexColumns, ConnectionWrapper conn, String lstIdEmpresa, boolean showEditableCombosECS, String specificFlexColumnsList) {
		...
		sb.append("<tr>");
			...
			if(flexColumns.contains(new ReporteECSFlexColumn("VAL_C3"))) { 
			...
			if(flexColumns.contains(new ReporteECSFlexColumn("VAL_C4"))) {
