				...
				if(btnEjecutar != null && btnEjecutar.equals("Generar")) {
					...
					for(int i=0; i < gdb.beans.size(); i++){
						...
						if(!TipoPoderCurrent.equals(TipoPoder)){								
							htmlout += "<h4 style='font-size:11pt'>"+(TipoPoder.equals("PG") ? "Poderes Generales" : TipoPoder.equals("PE") ? "Poderes Especiales" : TipoPoder.equals("CP") ? "Cartas Poder" : "Escrituras de Revocación") + "</h4>";
