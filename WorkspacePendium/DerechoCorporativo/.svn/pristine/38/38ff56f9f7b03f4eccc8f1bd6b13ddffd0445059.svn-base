...
import mx.com.televisa.derechocorporativo.modules.captura.Image;
...
public class ReporteECSCampo {
	...
	private String psEditable = "disabled";
	...
	public ReporteECSCampo(int idAddCampo, String codCampo, String nomCampo,
	 ...
	 * @throws Exception
	 */
	public ReporteECSCampo(ResultSet tuSet, ResultSetMetaData tuMetaData)
			throws Exception {
	...
	public String toHTML(Agrupaciones tuAgrupacion, String tsBgcolor,
			...
			boolean tbPrePair, boolean tbPair, Pagina pagina,String lstIdEmpresa) {
		...
		if (this.idCatalogo == 0) {
			if (this.desTipoCampo.equals(TYPE_TEXTAREA)) {
				...
				*(todos los de observaciones)*/
				...
				if (this.getPrintFlextable(tuConnect,lstIdEmpresa) == 0
	 ...
	 * @return int
	 */
	public int getPrintFlextable(ConnectionWrapper tuConnect,String liIdEmpresa) {
