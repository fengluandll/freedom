 ...
 */
@WebServlet("/ConsultaIdPoderesServletBkpDespuesDeArgu")
public class ConsultaIdPoderesServletBkpDespuesDeArgu extends HttpServlet {
	...
	public void processRequest(HttpServletRequest tuRequest
		...
		try{
			tuResponse.setContentType("text/html;charset=UTF-8"); 
			  ...
			  session.setAttribute("idCatalogoPoderes", idCatalogo);
