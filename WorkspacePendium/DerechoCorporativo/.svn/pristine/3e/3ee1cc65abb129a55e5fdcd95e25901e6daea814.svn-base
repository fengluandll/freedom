...
<title>Bitacora empresas modificacion</title>
...
<body>
	<script type="text/javascript">
		function validarFechas(){
			...
			<jsp:include page="/jsp/components/pages_border/open-pre-title.jsp"></jsp:include>
				...
				Bitacora Empresas Modificación
    ...
    <form id="fmBitaModifMan" name="fmBitaModifMan" method="post" action="/DerechoCorporativo/BitaCatalogo?reporte=bitaEmp">
        <table align="center">
        	<tr>
        		<td>
     				<fieldset>
