...
<%  String lsidEmp 				= request.getParameter("idEmpresa");
	...
	<div>
		<table width="70%" align="center" border="0">
		  ...
		  <tr>
		    <td class="formatoLetras1" style="text-align: justify;">Con motivo de la auditoría de los estados financieros de <%=nomEmpresa%> al 31 de diciembre de <%=lsEjercicio%> que están ustedes llevando a cabo, en mi carácter de responsable de los asuntos jurídicos corporativos,
			     he puesto a disposición de sus representantes los libros corporativos de dicha compañ&iacute;a, en los que constan las actas 
			     celebradas durante el ejercicio <%=lsEjercicio%> en las fechas que abajo se indican, de las cuales anexo copia fotostática.
		    </td>
