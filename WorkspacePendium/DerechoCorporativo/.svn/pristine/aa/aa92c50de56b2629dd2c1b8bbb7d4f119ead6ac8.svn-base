		...
		<table width="95%" height="100%" border="0" align="center">
			<tr>
				<td>
					...
					<tr>
				    <td background="<c:out value="${applicationBean.contextPath}"/>/img/borders/page_border/border04_azul.png">
					</td>
					
					<td width="100%" background="<c:out value="${applicationBean.contextPath}"/>/img/borders/page_border/border05.png">
					<!-- <td></td>  
					<td width="100%"> -->
					<!-- open-post-title.jsp -->	
					...
					<table width="98%" border="0" cellspacing="2" cellpadding="3"
						...
						<tr>
							...
							<td width="20%">
								...
								if(lstEditCon.equals("")){
								%>
								<input id= "btnCancelar"  type="button" name="cerrar" value="Salir" onClick="closePerspective()" >
								<%
								}
								%>
								-->
