...
public class ReporteECSFlexColumn {
	
private final static Logger log = Logger.getLogger(ReporteECSFlexColumn.class);
	...
	public String ATRIBUTO6; //ULR bandera para ocultar campos status reformas
	  ...
	  */
	  ...
	  public ReporteECSFlexColumn(String COD_FLEX_COLUM) {
	  ...
	  @Override
		public boolean equals(Object obj) {
			...
			return this.COD_FLEX_COLUM.equals(((ReporteECSFlexColumn) obj).COD_FLEX_COLUM);
		}
	  
	  
	  
		public ReporteECSFlexColumn(ResultSet set, ResultSetMetaData metaData) throws Exception {

			ReflexionUtil.fillObject(set, metaData, this, ReporteECSFlexColumn.class);
		}
		

		
		public static ArrayList<ReporteECSFlexColumn> getFlexColumns(String strIdFlexTbl, boolean tbIsHorizontal, boolean modoConfiguracioDeReportes) {
		...
		public static ArrayList<ReporteECSFlexColumn> getFlexColumns(int  idFlexTbl, ConnectionWrapper connect, 
			...
			ArrayList<ReporteECSFlexColumn> flexColumns = new ArrayList<ReporteECSFlexColumn>();
			ResultSet set = null;
			...
			try {
				...
				while (set.next()) {
					ReporteECSFlexColumn newFlexColum = new ReporteECSFlexColumn(set, set.getMetaData());
		...
		public static ArrayList<ReporteECSFlexColumn> getFlexColumns(
				int  idFlexTbl
		...
		public static ArrayList<ReporteECSFlexColumn> getFlexColumns(int  idFlexTbl
				, ConnectionWrapper connect, 
				boolean consultaResumen, 
				HttpServletRequest request,
				String idEmpresa,
				String otherCondition,
				boolean tbIsHorizontal,
				ReporteECSFlexTable tFlexTable,
				String tsConsulta,
				String tsIdMetaRow,
				String tipoPoder,
		...
		public static ReporteECSFlexColumn getFlexColumn(int  id, ConnectionWrapper connect) {
			...
			try {
				...
				while (set.next()) {
					...
					return new ReporteECSFlexColumn(set, set.getMetaData());
				}
		...
		public static ArrayList<ReporteECSFlexColumn> getFlexColumnsExcel(int  idFlexTbl, ConnectionWrapper connect, 
                boolean consultaResumen, 
                HttpServletRequest request,
                String idEmpresa, 
                String otherCondition,
