...
<body onload="">
			...
			<jsp:include page="/jsp/components/pages_border/open-pre-title.jsp"></jsp:include>
				...
				Reporte de Apoderados Revocados
...
%>
	...
	<tr>
		<td colspan="3" align="right">
			...
			%>
			<a href="apoderadosPrintRev.jsp?<%=paramString%>" target="_blank">Imprimir</a>
	...
	<tr>
							...
							<% for (CatalogElementV2 elemEscritura : elemsEscrituras) {
								...
								//String escritura = elemEscritura.getValValor();
								 ...
								 if(elemEscritura.getValC4() != null
									...
									List<DetailApoderadosDTO> elemsG = null;
		...
		List<DetailApoderadosDTO> elemsE = null;
		if(idCatalogoPoderes.equals("0")){
		...
		//-----------------------------TERMINA OCULTA PODERES ESPECIALES--------------------------------------	
								%>
									...
									<table width='95%' cellspacing='3' cellpadding='3' border=0 class='flexTable'>
									<%--
									<tr>
