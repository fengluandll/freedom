		...
		if(tipoPoderCurrent.equals(tipoPoder) && empresaCurrent.equals(empresa)){
			...
			case "PG": 
				...
				if(filterAD != null || filterAA != null || filterTC != null || filterPC != null){
					...
					+ "<th class='tableHeader' width='12%'>Actos de Dominio</th><th class='tableHeader' width='12%'>Actos de Administración</th><th class='tableHeader' width='12%'>Títulos de Crédito</th><th class='tableHeader' width='12%'>Pleitos y Cobranzas</th><th class='tableHeader' width='12%'>Vigencia</th></tr>";
				}
