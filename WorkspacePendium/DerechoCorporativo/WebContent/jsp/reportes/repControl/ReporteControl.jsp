...
<jsp:include page="/jsp/components/pages_border/open-pre-title.jsp"></jsp:include>
				...
				Reporte de Asuntos Corporativos
...
<script type="text/javascript">
        ...
        function validarFechas(){
            ...
            if(dDesde > dHasta)
            	...
            	document.getElementById("frmControl").submit();

		}
</script>        

<form id="frmControl" name="frmControl method="post" action="/DerechoCorporativo/ReporteControlServlet">
		...
		<td>
			<fieldset>
				...
				<div align="center">
					...
					<td colspan="2">
						<b>Solicitado Por:</b>
						<div id="divSolicitadoPor"><%= (request.getParameter("txtSolicitadoPor")!=null)?  TextFormatter.removeAccents( (new String(request.getParameter("txtSolicitadoPor").getBytes("ISO-8859-1"),"UTF-8")) ) : ""%></div>
					</td>
					<td class="">	
					<%String hiddenSolicitadoPor = 	(request.getParameter("hiddenSolicitadoPor") != null) ? request.getParameter("hiddenSolicitadoPor") : "";
					%>
							<div align='right'>
						<img src='<%= request.getContextPath() %>/img/btn_search.png' 
										onclick="openMultiSelectPupUp('56','hiddenSolicitadoPor','divSolicitadoPor','innerHTML',document.getElementById('hiddenSolicitadoPor').value,'UL')">
												
						<img src='<%= request.getContextPath() %>/img/btn_clean.png' 
										onclick="document.getElementById('hiddenSolicitadoPor').value = '';document.getElementById('divSolicitadoPor').innerHTML = '';">
						</div>
						
						
						<input type="hidden" id='hiddenSolicitadoPor' name='hiddenSolicitadoPor' value='<%=hiddenSolicitadoPor%>'>
