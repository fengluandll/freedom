...
function validarFecha(fecha){
	//con la expresion regular "/\D/g" se busca cualquier caracter que no sea un nÃºmero y los borra con el replace
	...
	if(valFecha==true && fechaString!=""){
		...
		function openActa(){
			...
			if(vIdEmpresa == ''){
				...
				swal("Es requerido introducir remitente y dirección");
				return;
			}
					...
					<td>
						<table>
							<tr>
								...
								<td>
									<textarea rows="5" cols="50" id='txtDireccion' name='txtDireccion'><%=datosReporte.get("Dirección").toString()%></textarea>
								</td>
							</tr>
						</table>
					</td>
