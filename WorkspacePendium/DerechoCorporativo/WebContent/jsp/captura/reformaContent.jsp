...
//	alert(globalSectionId);
	if(globalSectionId != 31 && globalSectionId != 32 &&
			   globalSectionId != 33 && globalSectionId != 34 &&
			   globalSectionId != 35 && globalSectionId != 36 &&
			   globalSectionId != 37 && globalSectionId != 38 &&
			   globalSectionId != 39 && globalSectionId != 40 &&
			   globalSectionId != 41 && globalSectionId != 42 &&
			   globalSectionId != 43){
    formmodified=0;
			...
			<tr>
				<td>
					...
					<table width="98%" border="0" cellspacing="2" cellpadding="3"
						...
						<tr>
							...
							<td width="20%">
								...
								<!--  <input id= "btnCancelar"  type="button" name="cerrar" value="Salir" onClick="go('<%=FacesUtils.getContextPath()%>/faces/jsp/captura/capWait.jsp?idEmp=<%=lstIdCurrentEmpresa%>&salida=true&idSeccion=<%=idSeccion %>');" > -->
									<input id= "btnCancelar"  type="button" name="cerrar" value="Salir" onClick="go('<%=FacesUtils.getContextPath()%>/faces/jsp/captura/waitReformaMenu.jsp?idEmp=<%=lstIdCurrentEmpresa%>&salida=true&idSeccion=<%=idSeccion %>');" > 
							</td>
						</tr>
						<!-- 
			             <tr>
						...
						<tr>
							<td colspan="3">
								<%=Pagina.getHTMLReforma(idSeccion)%>
							</td>
						</tr>
					</table> 
