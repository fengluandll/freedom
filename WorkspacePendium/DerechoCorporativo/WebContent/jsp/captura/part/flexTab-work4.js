...
function cambiarStatus(element){
	...
	if(flexTabId == 17){
	    if(element == 'No'){
		    ...
		    if(element == 'No'){
		    	document.getElementById('DIVC_18_VAL_C56_2').style.display = 'none';

		    	document.getElementById('DIVC_18_VAL_C57_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C58_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C59_2').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C60_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C61_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C62_2').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C63_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C64_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C65_2').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C66_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C67_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C68_2').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C69_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C70_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C71_2').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C72_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C73_2').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C74_2').style.display = 'none';
	    		////////////////////////////////////////////////////////////////////
		    	document.getElementById('DIVC_18_VAL_C56_1').style.display = 'none';

		    	document.getElementById('DIVC_18_VAL_C57_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C58_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C59_1').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C60_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C61_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C62_1').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C63_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C64_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C65_1').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C66_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C67_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C68_1').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C69_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C70_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C71_1').style.display = 'none';

	    		document.getElementById('DIVC_18_VAL_C72_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C73_1').style.display = 'none';
	    		document.getElementById('DIVC_18_VAL_C74_1').style.display = 'none';


	    	}else{
		    	document.getElementById('DIVC_18_VAL_C56_2').style.display = 'block';
	
		    	document.getElementById('DIVC_18_VAL_C57_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C58_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C59_2').style.display = 'block';
	
	    		document.getElementById('DIVC_18_VAL_C60_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C61_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C62_2').style.display = 'block';
	
	    		document.getElementById('DIVC_18_VAL_C63_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C64_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C65_2').style.display = 'block';
	
	    		document.getElementById('DIVC_18_VAL_C66_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C67_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C68_2').style.display = 'block';
	
	    		document.getElementById('DIVC_18_VAL_C69_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C70_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C71_2').style.display = 'block';
	
	    		document.getElementById('DIVC_18_VAL_C72_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C73_2').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C74_2').style.display = 'block';
	    		/////////////////////////////////////////////////////////////////////
		    	document.getElementById('DIVC_18_VAL_C56_1').style.display = 'block';

		    	document.getElementById('DIVC_18_VAL_C57_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C58_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C59_1').style.display = 'block';

	    		document.getElementById('DIVC_18_VAL_C60_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C61_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C62_1').style.display = 'block';

	    		document.getElementById('DIVC_18_VAL_C63_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C64_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C65_1').style.display = 'block';

	    		document.getElementById('DIVC_18_VAL_C66_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C67_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C68_1').style.display = 'block';

	    		document.getElementById('DIVC_18_VAL_C69_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C70_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C71_1').style.display = 'block';

	    		document.getElementById('DIVC_18_VAL_C72_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C73_1').style.display = 'block';
	    		document.getElementById('DIVC_18_VAL_C74_1').style.display = 'block';
    	...
    	if(element == 'No'){
	    	...
	    	document.getElementById('DIVC_20_VAL_C37_2').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C38_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C39_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C40_2').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C47_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C48_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C49_2').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C41_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C42_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C43_2').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C50_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C51_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C52_2').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C44_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C45_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C46_2').style.display = 'none';
    		
	    	document.getElementById('DIVC_20_VAL_C53_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C54_2').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C55_2').style.display = 'none';
    		////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_20_VAL_C37_1').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C38_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C39_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C40_1').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C47_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C48_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C49_1').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C41_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C42_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C43_1').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C50_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C51_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C52_1').style.display = 'none';

	    	document.getElementById('DIVC_20_VAL_C44_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C45_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C46_1').style.display = 'none';
    		
	    	document.getElementById('DIVC_20_VAL_C53_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C54_1').style.display = 'none';
    		document.getElementById('DIVC_20_VAL_C55_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_20_VAL_C37_2').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C38_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C39_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C40_2').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C47_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C48_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C49_2').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C41_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C42_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C43_2').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C50_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C51_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C52_2').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C44_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C45_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C46_2').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C53_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C54_2').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C55_2').style.display = 'block';
            /////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_20_VAL_C37_1').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C38_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C39_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C40_1').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C47_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C48_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C49_1').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C41_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C42_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C43_1').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C50_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C51_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C52_1').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C44_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C45_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C46_1').style.display = 'block';

	    	document.getElementById('DIVC_20_VAL_C53_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C54_1').style.display = 'block';
    		document.getElementById('DIVC_20_VAL_C55_1').style.display = 'block';

    	}
    }
    else if(flexTabId == 21){
    	if(element == 'No'){
	    	document.getElementById('DIVC_21_VAL_C28_2').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C29_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C30_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C31_2').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C32_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C33_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C34_2').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C35_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C36_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C37_2').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C38_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C39_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C40_2').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C41_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C42_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C43_2').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C44_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C45_2').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C46_2').style.display = 'none';
    		////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_21_VAL_C28_1').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C29_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C30_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C31_1').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C32_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C33_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C34_1').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C35_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C36_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C37_1').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C38_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C39_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C40_1').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C41_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C42_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C43_1').style.display = 'none';

	    	document.getElementById('DIVC_21_VAL_C44_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C45_1').style.display = 'none';
    		document.getElementById('DIVC_21_VAL_C46_1').style.display = 'none';


    	}else{
	    	document.getElementById('DIVC_21_VAL_C28_2').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C29_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C30_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C31_2').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C32_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C33_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C34_2').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C35_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C36_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C37_2').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C38_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C39_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C40_2').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C41_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C42_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C43_2').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C44_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C45_2').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C46_2').style.display = 'block';
    		/////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_21_VAL_C28_1').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C29_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C30_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C31_1').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C32_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C33_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C34_1').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C35_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C36_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C37_1').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C38_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C39_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C40_1').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C41_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C42_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C43_1').style.display = 'block';

	    	document.getElementById('DIVC_21_VAL_C44_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C45_1').style.display = 'block';
    		document.getElementById('DIVC_21_VAL_C46_1').style.display = 'block';

    	}
    }
    else if(flexTabId == 22){
    	if(element == 'No'){
	    	document.getElementById('DIVC_22_VAL_C35_2').style.display = 'none';

	    	document.getElementById('DIVC_22_VAL_C36_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C37_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C38_2').style.display = 'none';

	    	document.getElementById('DIVC_22_VAL_C39_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C40_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C41_2').style.display = 'none';

	    	document.getElementById('DIVC_22_VAL_C42_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C43_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C44_2').style.display = 'none';

    		document.getElementById('DIVC_22_VAL_C45_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C46_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C47_2').style.display = 'none';

    		document.getElementById('DIVC_22_VAL_C48_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C49_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C50_2').style.display = 'none';

    		document.getElementById('DIVC_22_VAL_C51_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C52_2').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C53_2').style.display = 'none';
    		////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_22_VAL_C35_1').style.display = 'none';

	    	document.getElementById('DIVC_22_VAL_C36_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C37_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C38_1').style.display = 'none';

	    	document.getElementById('DIVC_22_VAL_C39_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C40_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C41_1').style.display = 'none';

	    	document.getElementById('DIVC_22_VAL_C42_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C43_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C44_1').style.display = 'none';

    		document.getElementById('DIVC_22_VAL_C45_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C46_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C47_1').style.display = 'none';

    		document.getElementById('DIVC_22_VAL_C48_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C49_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C50_1').style.display = 'none';

    		document.getElementById('DIVC_22_VAL_C51_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C52_1').style.display = 'none';
    		document.getElementById('DIVC_22_VAL_C53_1').style.display = 'none';


    	}else{
	    	document.getElementById('DIVC_22_VAL_C35_2').style.display = 'block';

	    	document.getElementById('DIVC_22_VAL_C36_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C37_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C38_2').style.display = 'block';

	    	document.getElementById('DIVC_22_VAL_C39_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C40_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C41_2').style.display = 'block';

	    	document.getElementById('DIVC_22_VAL_C42_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C43_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C44_2').style.display = 'block';

    		document.getElementById('DIVC_22_VAL_C45_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C46_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C47_2').style.display = 'block';

    		document.getElementById('DIVC_22_VAL_C48_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C49_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C50_2').style.display = 'block';

    		document.getElementById('DIVC_22_VAL_C51_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C52_2').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C53_2').style.display = 'block';
    		/////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_22_VAL_C35_1').style.display = 'block';

	    	document.getElementById('DIVC_22_VAL_C36_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C37_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C38_1').style.display = 'block';

	    	document.getElementById('DIVC_22_VAL_C39_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C40_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C41_1').style.display = 'block';

	    	document.getElementById('DIVC_22_VAL_C42_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C43_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C44_1').style.display = 'block';

    		document.getElementById('DIVC_22_VAL_C45_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C46_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C47_1').style.display = 'block';

    		document.getElementById('DIVC_22_VAL_C48_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C49_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C50_1').style.display = 'block';

    		document.getElementById('DIVC_22_VAL_C51_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C52_1').style.display = 'block';
    		document.getElementById('DIVC_22_VAL_C53_1').style.display = 'block';

    	}
    }else if(flexTabId == 23){
    	if(element == 'No'){
	    	document.getElementById('DIVC_23_VAL_C67_2').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C68_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C69_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C70_2').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C71_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C72_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C73_2').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C74_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C75_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C76_2').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C77_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C78_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C79_2').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C80_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C81_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C82_2').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C83_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C84_2').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C85_2').style.display = 'none';
    		////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_23_VAL_C67_1').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C68_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C69_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C70_1').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C71_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C72_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C73_1').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C74_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C75_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C76_1').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C77_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C78_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C79_1').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C80_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C81_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C82_1').style.display = 'none';

	    	document.getElementById('DIVC_23_VAL_C83_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C84_1').style.display = 'none';
    		document.getElementById('DIVC_23_VAL_C85_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_23_VAL_C67_2').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C68_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C69_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C70_2').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C71_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C72_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C73_2').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C74_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C75_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C76_2').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C77_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C78_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C79_2').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C80_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C81_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C82_2').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C83_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C84_2').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C85_2').style.display = 'block';
    		/////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_23_VAL_C67_1').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C68_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C69_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C70_1').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C71_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C72_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C73_1').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C74_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C75_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C76_1').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C77_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C78_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C79_1').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C80_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C81_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C82_1').style.display = 'block';

	    	document.getElementById('DIVC_23_VAL_C83_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C84_1').style.display = 'block';
    		document.getElementById('DIVC_23_VAL_C85_1').style.display = 'block';

    	}
    }else if(flexTabId == 27){
    	if(element == 'No'){
	    	document.getElementById('DIVC_27_VAL_C6_2').style.display = 'none';
	    	document.getElementById('DIVC_27_VAL_C7_2').style.display = 'none';
	    	document.getElementById('DIVC_27_VAL_C8_2').style.display = 'none';
	    	///////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_27_VAL_C6_1').style.display = 'none';
	    	document.getElementById('DIVC_27_VAL_C7_1').style.display = 'none';
	    	document.getElementById('DIVC_27_VAL_C8_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_27_VAL_C6_2').style.display = 'block';
	    	document.getElementById('DIVC_27_VAL_C7_2').style.display = 'block';
	    	document.getElementById('DIVC_27_VAL_C8_2').style.display = 'block';
	    	///////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_27_VAL_C6_1').style.display = 'block';
	    	document.getElementById('DIVC_27_VAL_C7_1').style.display = 'block';
	    	document.getElementById('DIVC_27_VAL_C8_1').style.display = 'block';

    	}
    }else if(flexTabId == 28){
    	if(element == 'No'){
	    	document.getElementById('DIVC_28_VAL_C7_2').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C8_2').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C9_2').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C10_2').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C11_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_28_VAL_C7_1').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C8_1').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C9_1').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C10_1').style.display = 'none';
	    	document.getElementById('DIVC_28_VAL_C11_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_28_VAL_C7_2').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C8_2').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C9_2').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C10_2').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C11_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_28_VAL_C7_1').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C8_1').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C9_1').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C10_1').style.display = 'block';
	    	document.getElementById('DIVC_28_VAL_C11_1').style.display = 'block';
    		
    	}
    }else if(flexTabId == 29){
    	if(element == 'No'){
	    	document.getElementById('DIVC_29_VAL_C19_2').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C20_2').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C21_2').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C22_2').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C23_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_29_VAL_C19_1').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C20_1').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C21_1').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C22_1').style.display = 'none';
	    	document.getElementById('DIVC_29_VAL_C23_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_29_VAL_C19_2').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C20_2').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C21_2').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C22_2').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C23_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_29_VAL_C19_1').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C20_1').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C21_1').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C22_1').style.display = 'block';
	    	document.getElementById('DIVC_29_VAL_C23_1').style.display = 'block';
    		
    	}
    }else if(flexTabId == 30){
    	if(element == 'No'){
	    	document.getElementById('DIVC_30_VAL_C15_2').style.display = 'none';
	    	document.getElementById('DIVC_30_VAL_C16_2').style.display = 'none';
	    	document.getElementById('DIVC_30_VAL_C17_2').style.display = 'none';
	    	document.getElementById('DIVC_30_VAL_C18_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_30_VAL_C15_1').style.display = 'none';
	    	document.getElementById('DIVC_30_VAL_C16_1').style.display = 'none';
	    	document.getElementById('DIVC_30_VAL_C17_1').style.display = 'none';
	    	document.getElementById('DIVC_30_VAL_C18_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_30_VAL_C15_2').style.display = 'block';
	    	document.getElementById('DIVC_30_VAL_C16_2').style.display = 'block';
	    	document.getElementById('DIVC_30_VAL_C17_2').style.display = 'block';
	    	document.getElementById('DIVC_30_VAL_C18_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_30_VAL_C15_1').style.display = 'block';
	    	document.getElementById('DIVC_30_VAL_C16_1').style.display = 'block';
	    	document.getElementById('DIVC_30_VAL_C17_1').style.display = 'block';
	    	document.getElementById('DIVC_30_VAL_C18_1').style.display = 'block';

    	}
    }else if(flexTabId == 31){
    	if(element == 'No'){
	    	document.getElementById('DIVC_31_VAL_C9_2').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C10_2').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C11_2').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C12_2').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C13_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_31_VAL_C9_1').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C10_1').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C11_1').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C12_1').style.display = 'none';
	    	document.getElementById('DIVC_31_VAL_C13_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_31_VAL_C9_2').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C10_2').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C11_2').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C12_2').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C13_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_31_VAL_C9_1').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C10_1').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C11_1').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C12_1').style.display = 'block';
	    	document.getElementById('DIVC_31_VAL_C13_1').style.display = 'block';

    	}
    }else if(flexTabId == 32){
    	if(element == 'No'){
	    	document.getElementById('DIVC_32_VAL_C19_2').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C20_2').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C21_2').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C22_2').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C23_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_32_VAL_C19_1').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C20_1').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C21_1').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C22_1').style.display = 'none';
	    	document.getElementById('DIVC_32_VAL_C23_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_32_VAL_C19_2').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C20_2').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C21_2').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C22_2').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C23_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_32_VAL_C19_1').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C20_1').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C21_1').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C22_1').style.display = 'block';
	    	document.getElementById('DIVC_32_VAL_C23_1').style.display = 'block';

    	}
    }else if(flexTabId == 33){
    	if(element == 'No'){
	    	document.getElementById('DIVC_33_VAL_C21_2').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C22_2').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C23_2').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C24_2').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C25_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_33_VAL_C21_1').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C22_1').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C23_1').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C24_1').style.display = 'none';
	    	document.getElementById('DIVC_33_VAL_C25_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_33_VAL_C21_2').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C22_2').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C23_2').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C24_2').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C25_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_33_VAL_C21_1').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C22_1').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C23_1').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C24_1').style.display = 'block';
	    	document.getElementById('DIVC_33_VAL_C25_1').style.display = 'block';

    	}
    }else if(flexTabId == 34){
    	if(element == 'No'){
	    	document.getElementById('DIVC_34_VAL_C23_2').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C24_2').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C25_2').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C26_2').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C27_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_34_VAL_C23_1').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C24_1').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C25_1').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C26_1').style.display = 'none';
	    	document.getElementById('DIVC_34_VAL_C27_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_34_VAL_C23_2').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C24_2').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C25_2').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C26_2').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C27_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_34_VAL_C23_1').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C24_1').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C25_1').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C26_1').style.display = 'block';
	    	document.getElementById('DIVC_34_VAL_C27_1').style.display = 'block';
    		
    	}
    }else if(flexTabId == 35){
    	if(element == 'No'){
	    	document.getElementById('DIVC_35_VAL_C8_2').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C9_2').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C10_2').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C11_2').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C12_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_35_VAL_C8_1').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C9_1').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C10_1').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C11_1').style.display = 'none';
	    	document.getElementById('DIVC_35_VAL_C12_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_35_VAL_C8_2').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C9_2').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C10_2').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C11_2').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C12_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_35_VAL_C8_1').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C9_1').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C10_1').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C11_1').style.display = 'block';
	    	document.getElementById('DIVC_35_VAL_C12_1').style.display = 'block';

    	}
    }else if(flexTabId == 41){
    	if(element == 'No'){
	    	document.getElementById('DIVC_41_VAL_C8_2').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C9_2').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C10_2').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C11_2').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C12_2').style.display = 'none';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_41_VAL_C8_1').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C9_1').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C10_1').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C11_1').style.display = 'none';
	    	document.getElementById('DIVC_41_VAL_C12_1').style.display = 'none';

    	}else{
	    	document.getElementById('DIVC_41_VAL_C8_2').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C9_2').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C10_2').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C11_2').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C12_2').style.display = 'block';
	    	////////////////////////////////////////////////////////////////////
	    	document.getElementById('DIVC_41_VAL_C8_1').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C9_1').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C10_1').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C11_1').style.display = 'block';
	    	document.getElementById('DIVC_41_VAL_C12_1').style.display = 'block';
