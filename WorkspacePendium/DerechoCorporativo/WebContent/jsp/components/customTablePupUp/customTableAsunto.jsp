...
<script type="text/javascript" src="<%= request.getContextPath() %>/js/asunto/asunto.js"></script>
...
<table width="100%">
	<tr>
		<td style="text-align: right;">
			<input type="button" id="btnSendAsunto" value="Aceptar">
		</td>
	</tr>
</table>

<div id="contentForms" class="light-color">
		<form id="formUpdateAsunto" class="hidden" onsubmit="return false">
			...
			<table width="100%" style="margin-top:20px; margin-bottom: 20px;">
				...
				<tr>
					...
					<td><input type="text" id="idAsuntoU" name="idAsuntoU" size="40"></td>
				</tr>
				<tr>
					<td style="text-align: right; padding-right: 5px;"><label><b>Se aprobó</label></td>
					<td><textarea id="asuntoU" name="asuntoU" cols='40'></textarea>
		...
		<form id="formAsunto" onsubmit="return false"><!-- inicia form para agregar un nuevo ejercicio -->
			...
			<table width="100%" style="margin-top:20px; margin-bottom: 20px;">
				...
				<tr>
					<td width="35%" style="text-align: right; padding-right: 5px;"><label><b>Id</b></label></td>
					<td><input type="text" id="idAsunto" name="idAsunto" size="40"></td>
				</tr>
				<tr>
					<td style="text-align: right; padding-right: 5px;"><label><b>Se aprobó</label></td>
					<td><textarea id="asunto" name="asunto" cols='50' ></textarea></td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right;">
...
<table width="100%" id="tableAsuntos">
	<tr>
		<td>
			<div id="myTable">
				<table width="100%">
					<thead>
						<tr>
							...
							<th class="tableHeaderAlfa2">Se aprobó</th>
