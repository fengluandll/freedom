...
<script type="text/javascript">
	...
	function confirmSelection(id, text) {
		
		window.opener.document.getElementById(<%=targetIds%>).value = id;
		window.opener.document.getElementById(<%=targetNames%>).<%=namesProperty %> = removeDiacritics(text);
...
<table width="100%">
	...
	<tr>
		<td>
		Buscar: 
			<input type="text" id="filter" onkeyup="searchElements()" size='50'>
		</td>
	</tr>	
	<tr>
		<td>&nbsp;
