...
public class SendEmail {
	...
	public SendEmail(MailParamBean mailParamBean) {
		  bundle 	    = ResourceBundle.getBundle("ParametrosMail");
		  
		  // Recipient's email ID needs to be mentioned.
	      String to = mailParamBean.getTo();
	      
	      // Sender's email ID needs to be mentioned
	      String from = mailParamBean.getFrom();
	      final String username = mailParamBean.getUserName();//change accordingly
	      final String password = mailParamBean.getPassword();//change accordingly
	      ...
	      try {
		   ...
		   message.setSubject(mailParamBean.getSubJect());
	 ...
	 */
	public void enviaConImagen(String rutaImagen){
		try{
	...
	public static void main(String[] args) {
		...
		new SendEmail(mailParamBean).enviaSinImagen("<html><h1>hola</h1></html>");;
	}
}
