...
public class SupplierDAO {
    ...
    Connection conexion;
    private SupplierBean dtData;
    //private ComboBoxBean dtCmb;
    List<SupplierBean> listSupplier;
	...
	public String fnDeleteSupplier(String p_vendor_id, String p_user_id){
        String lstSqlQuery="";
        String linReturn="";

        lstSqlQuery = "SELECT Supplier_delete_fn (?, ?) regreso";
	...
	public String fnUpdateSupplier(int p_vendor_id, String p_first_name, String p_last_name, 
        ...
        lstSqlQuery = "SELECT Supplier_update_fn (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) regreso";
        sqlConn = new MySqlConexion();
	...
	public String fnInsertSupplier(String p_first_name, String p_last_name, 
			String p_business_name, String p_rfc, String p_address_line1, String p_address_line2, 
			String p_address_line3, String p_city, String p_state, String p_country, String p_postal_code, 
			String p_segment1, String p_segment2, String p_segment3, String p_segment4, String p_segment5, 
			String p_segment6, String p_segment7, String p_segment8, String p_segment9, String p_email, 
        ...
        lstSqlQuery = "SELECT Supplier_insert_fn (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) regreso";
        sqlConn = new MySqlConexion();
	...
	public int fnSupplierExist(String p_rfc){
	...
	public List<SupplierBean> fnLoadData(String p_first_name, String p_last_name, String p_rfc, String p_business_name){
		String lstSqlQuery="";
		listSupplier = new ArrayList<SupplierBean>();
        lstSqlQuery = " SELECT vendor_id, first_name, last_name, business_name, rfc, address_line1, address_line2,  "+
        			  ...
        			  lstSqlQuery = lstSqlQuery + " ORDER BY business_name, rfc, first_name, last_name, vendor_id";
        sqlConn = new MySqlConexion();
        ...
        try {
            ...
            rs = pstmt.executeQuery();
            while (rs.next()){
            	dtData = new SupplierBean(rs.getInt("vendor_id"), rs.getString("first_name"), rs.getString("last_name"), rs.getString("business_name"), 
