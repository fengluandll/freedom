...
public class NotasBeans implements Serializable{
	
	
	private static final long serialVersionUID = 1L;
	private int 		  noteId;
	private int 		  studenPersonaltId;
	...
	public int getStudenPersonaltId() {
		return studenPersonaltId;
	}
	public void setStudenPersonaltId(int studenPersonaltId) {
		this.studenPersonaltId = studenPersonaltId;
	}
