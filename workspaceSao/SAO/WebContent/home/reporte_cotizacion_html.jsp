													...
													<td>
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																...
																<!-- ENCABEZADOS INTERPRETACION PRODUCTOS CATALOGO HEAD -->
															...
															%>
																			<tr style="height: 30px">
																				...
																				<!-- ENCABEZADOS INTERPRETACION PRODUCTOS CATALOGO CONTENT -->
															...
															<tr style="height: 30px">
																...
																<!-- ENCABEZADOS INTERPRETACION PRODUCTOS ABIERTOS CONTENT -->
															...
															<% if (header.get("texto_subtotal_1") != null && !header.get("texto_subtotal_1").equals("")) { %>
																	<tr>
																		...
																		<!-- ENCABEZADOS INTERPRETACION PRODUCTOS TOTAL -->
								...
								%>
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td width="40%" align="left" ><b><%=subtotalTexto%></b></td>
													...
													<table width="100%" >
														<tr>
															...
															<th width="11.66%"><center><% if (english) { %>Delivery<% } else { %>Entrega<% } %>
																...
																<!-- ENCABEZADOS ESCRITA PRODUCTOS CATALOGO HEAD -->
...
<!-- 																		<td width="11.66%" class="" align="center">&nbsp;</td> -->
														...
														%>
																	...
																	<!-- ENCABEZADOS ESCRITA PRODUCTOS CATALOGO CONTENT -->
													...
													<table width="100%" border="0">
														...
														%>
																	<tr>
																		...
																		<!-- ENCABEZADOS ESCRITA PRODUCTOS ABIERTOS CONTENT -->
				...
				%>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<% if ("1".equals(evento.getString("id_mostrar_precios"))) { %>
										<td align="right" width="25%"><%=CotizacionReportUtil.formatoConMoneda2(subtotalGeneralCliente, id_tipo_cotizacion, english)%></td>
										<td align="right" width="25%"><%=CotizacionReportUtil.formatoConMoneda2(subtotalGeneralEspecial, id_tipo_cotizacion, english)%></td>
								<% } else if ("2".equals(evento.getString("id_mostrar_precios"))) { %>
										<td align="right" width="50%"><%=CotizacionReportUtil.formatoConMoneda2(subtotalGeneralCliente, id_tipo_cotizacion, english)%></td>
								<% } else if ("3".equals(evento.getString("id_mostrar_precios"))) { %>
										<td align="right" width="50%"><%=CotizacionReportUtil.formatoConMoneda2(subtotalGeneralEspecial, id_tipo_cotizacion, english)%></td>
								<% } %>
									</b>
							</tr>
							<tr>
