         ...
         <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <p><strong>AGENDA T&Eacute;CNICO</strong> </p>
                  ...
                  <div class="x_content">
                    ...
                    <div align="right">
                  	<div class="row">
	                  	...
	                  	<div class="col-sm-1">
	                  		<input type="button" value="Buscar" onclick="funcObtenerAgendaTecnicos();">
	                  	</div>
                    </div>
                    </div>
...
<!-- FullCalendar -->
    ...
    <script>
      ...
      $(window).load(function() {
        ...
        var argEventos = <%= Agenda.getAgendaEventoPorTecnico()%>;
