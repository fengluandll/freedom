...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>Prosant&eacute; - Clientes</title>
         ...
         <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <p><strong>Clientes / Listado de Clientes </strong> </p>
                  ...
                  <div class="x_content">
                    ...
                    <div align="right">
                    <p class="text-muted font-13 m-b-30">
                      <a href="nueva_empresa.jsp" type="button" class="btn btn-info">Nuevo Cliente</a>
                    </p>
                    <br>
                    </div>	
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>     
                          ...
                          <th>Tel&eacute;fono del Contacto </th>
                          <th>Correo Electr&oacute;nico del Contacto </th>
                          <th>Administrar</th>                      
                        </tr>
                      </thead>
                      ...
                      <tbody>                                                
                        ...
                        Statement stUser = conn.createStatement();
                   		ResultSet rsUser = stUser.executeQuery("SELECT * FROM empresa");
                  		while(rsUser.next()){
            		      %>
            		      <tr>
	            		      ...
	            		      <td><%=rsUser.getString(6) %></td>
            		          <td align="center"><a href="adm_empresas_edit.jsp?ID=<%=rsUser.getString(1)%>" class="btn btn-info"><i class="fa fa-pencil"></i> Editar Cliente </a> </td>
