...
public class PoliticasAplicablesTable {

	private ServletRequest request;

	public PoliticasAplicablesTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("evento_politicas_applic_select_pr", id_evento_version, idTipoEvento);
		...
		columns.add(new HTMLTableColumn("Agregar", 					"id_politica", 		"center", 	"link", 	"onclick='agregarPolitica(id_politica)'", "<i class=\"fa fa-plus fa-2x\"></i>"));
