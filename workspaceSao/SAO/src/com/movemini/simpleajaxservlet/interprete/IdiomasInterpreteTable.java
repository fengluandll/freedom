...
public class IdiomasInterpreteTable {

	private ServletRequest request;
	
	public IdiomasInterpreteTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("interprete_idiomas_select_pr", id_interprete);
...
//		columns.add(new HTMLTableColumn("Ver Fechas", 					"id", 		"center", 	"link", 	"onclick='selectSede(id)'", "<i class=\"fa fa-calendar fa-2x\"></i>"));
		...
		columns.add(new HTMLTableColumn("Quitar", 					"id_interprete_idioma", 		"center", 	"link", 	"onclick='quitarIdioma(id_interprete_idioma)'", "<i class=\"fa fa-close fa-2x\"></i>"));
