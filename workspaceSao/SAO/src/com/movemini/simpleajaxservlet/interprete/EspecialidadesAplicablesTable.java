...
public class EspecialidadesAplicablesTable {

	private ServletRequest request;
	
	public EspecialidadesAplicablesTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("interprete_especialidades_applic_select_pr", id_interprete);
		...
		columns.add(new HTMLTableColumn("Agregar", 					"id_especialidad", 		"center", 	"link", 	"onclick='agregarEspecialidad(id_especialidad)'", "<i class=\"fa fa-plus fa-2x\"></i>"));
