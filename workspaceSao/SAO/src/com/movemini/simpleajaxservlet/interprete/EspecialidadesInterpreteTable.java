...
public class EspecialidadesInterpreteTable {

	private ServletRequest request;
	
	public EspecialidadesInterpreteTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("interprete_especialidades_select_pr", id_interprete);
		...
		columns.add(new HTMLTableColumn("Especialidad", 				"nombre", 		"left", 	"label", 	"")); //"onkeyup='updateSede(KEY, this)'"
...
//		columns.add(new HTMLTableColumn("Ver Fechas", 					"id", 		"center", 	"link", 	"onclick='selectSede(id)'", "<i class=\"fa fa-calendar fa-2x\"></i>"));
		...
		columns.add(new HTMLTableColumn("Quitar", 					"id_interprete_especialidad", 		"center", 	"link", 	"onclick='quitarEspecialidad(id_interprete_especialidad)'", "<i class=\"fa fa-close fa-2x\"></i>"));
