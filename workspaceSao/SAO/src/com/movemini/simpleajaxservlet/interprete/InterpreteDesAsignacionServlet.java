 ...
 */
@WebServlet("/InterpreteDesAsignacionServlet")
public class InterpreteDesAsignacionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InterpreteDesAsignacionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "UPDATE evento_interprete SET id_interprete = null "
