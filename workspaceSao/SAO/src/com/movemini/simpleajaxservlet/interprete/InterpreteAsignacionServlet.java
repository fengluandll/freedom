 ...
 */
@WebServlet("/InterpreteAsignacionServlet")
public class InterpreteAsignacionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InterpreteAsignacionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "UPDATE evento_interprete SET id_interprete = '" + id_interprete + "' "
