...
public class CondicionesEventoTable {

	private ServletRequest request;

	public CondicionesEventoTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("evento_condicion_select_pr", id_evento_version);
...
//		columns.add(new HTMLTableColumn("Ver Fechas", 					"id", 		"center", 	"link", 	"onclick='selectSede(id)'", "<i class=\"fa fa-calendar fa-2x\"></i>"));
		...
		columns.add(new HTMLTableColumn("Quitar", 					"id_evento_condicion", 		"center", 	"link", 	"onclick='quitarCondicion(id_evento_condicion)'", "<i class=\"fa fa-close fa-2x\"></i>"));
