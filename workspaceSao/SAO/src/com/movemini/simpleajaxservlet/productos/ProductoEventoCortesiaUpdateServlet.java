 ...
 */
@WebServlet("/ProductoEventoCortesiaUpdateServlet")
public class ProductoEventoCortesiaUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductoEventoCortesiaUpdateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "UPDATE evento_producto SET cortesia = "+ cortesia +" WHERE id_evento_producto = '" + id_evento_producto + "'";
