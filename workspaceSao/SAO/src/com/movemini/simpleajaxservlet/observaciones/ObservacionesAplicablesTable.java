...
public class ObservacionesAplicablesTable {

	private ServletRequest request;

	public ObservacionesAplicablesTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("evento_observaciones_applic_select_pr", id_evento_version, idTipoEvento);
		...
		columns.add(new HTMLTableColumn("Agregar", 					"id_observacion", 		"center", 	"link", 	"onclick='agregarObservacion(id_observacion)'", "<i class=\"fa fa-plus fa-2x\"></i>"));
