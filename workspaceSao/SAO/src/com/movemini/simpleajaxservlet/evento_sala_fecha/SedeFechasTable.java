...
public class SedeFechasTable {


	private ServletRequest request;
	
	public SedeFechasTable(ServletRequest request) {
	...
	public String getHtml() {
		...
		ArrayList<Record> records = DataArray.getArrayList("evento_sala_dias_pr", id_sala);
		...
		columns.add(new HTMLTableColumn("Fecha", 						"fecha", 		"left", 	"date", 	"onChange='updateSalaFecha(KEY, this)'"));
		...
		columns.add(new HTMLTableColumn("Borrar Fecha", 					"id_evento_sala_dia", 				"center", 	"link", 	"onclick='if(confirm(\"¿Seguro que desea eliminar el Día?\")){deleteSalaFecha(id_evento_sala_dia);}'", "<i class=\"fa fa-close fa-2x\"></i>"));
