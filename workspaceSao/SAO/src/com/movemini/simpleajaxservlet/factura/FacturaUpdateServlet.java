 ...
 */
@WebServlet("/FacturaUpdateServlet")
public class FacturaUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public FacturaUpdateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "UPDATE evento_factura SET " + field_id + " = '" + field_value + "' WHERE id_factura = '" + id_interprete + "'";
