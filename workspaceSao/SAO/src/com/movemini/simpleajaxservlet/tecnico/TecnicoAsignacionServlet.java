 ...
 */
@WebServlet("/TecnicoAsignacionServlet")
public class TecnicoAsignacionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TecnicoAsignacionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		mnjTecnico.actualizarAsignacionTecnico(idTecnico, idEventoTecnico);
