...
/*import mx.com.foodsol.erp.data.ConnectionWrapper;
import mx.com.foodsol.erp.mvc.controller.flex.FlexField;
import mx.com.foodsol.erp.mvc.model.oper.Recipe;
*/
	...
	public static String getListByQuery(String htmlElementId, String query, String selectText, String moreAttributes, String currVal) {
		...
		try {
			...
			sb.append("<select id='" + htmlElementId + "' name='" + htmlElementId + "' " + moreAttributes + " "
					+ "style=\"width: 40px;\" class=\"form-control\" style=\"padding-left: 0px;\" required>");
