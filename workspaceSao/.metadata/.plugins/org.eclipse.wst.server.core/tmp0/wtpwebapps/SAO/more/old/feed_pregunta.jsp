...
try
{
    ...
    //System.out.println("ID_USER: " + session.getAttribute("ID_USER"));
    //System.out.println("ID_REGUNTA: " + request.getParameter("ID_REGUNTA"));
    ...
    if(request.getParameter("EventoEdit") != null){
	      String upDateUser = "UPDATE cat_preguntaspre SET NOMBRE=?, BLOQUE=? WHERE ID = ?";
	      ...
	      preparedStmtUser.setString (2, request.getParameter("BLOQUE").toString());
	      preparedStmtUser.setInt    (3, Integer.parseInt(request.getParameter("ID_PREGUNTA_C").toString()));
    ...
    }else if(session.getAttribute("ID_USER") != null & request.getParameter("ID_PREGUNTA") != null //& request.getParameter("ID_EMPRESA") != null
    		) {    	    	
    	...
    	ResultSet rsEditEvento = stEditEvento.executeQuery("SELECT * FROM cat_preguntaspre WHERE ID = "+request.getParameter("ID_PREGUNTA")+"");
    	String[] lstEvento = new String[12];
    	while(rsEditEvento.next()){
    		lstEvento[0] =  rsEditEvento.getString("ID");
    		lstEvento[1] =  rsEditEvento.getString("NOMBRE");
    		lstEvento[2] =  rsEditEvento.getString("BLOQUE");
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>Prosant&eacute; - Preguntas Edicion</title>
         ...
         <div class="right_col" role="main">
          <div class="">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <p><strong>Sistema de Captura de Prosant&eacute; Evento </p>
                  ...
                  <div style="width: 420px;">
                    ...
                    <form id="demo-form" class="form-horizontal form-label-left" data-parsley-validate action="" method="post">                                
					  ...
					  <input type="hidden" name="ID_PREGUNTA_C" value="<%=lstEvento[0]%>"> 
                      <label for="text" style="display: inline-block;">Pregunta:</label> 
                      
                      
                      
                      <!--  input type="text" name="NOMBRE" class="form-control" placeholder="ej. Prosant&eacute; " required value=" < % =lstEvento[1] % >" style="width: 400px" -->
                      
                      <textarea rows="5" cols="30" name="NOMBRE" class="form-control" required><%=lstEvento[1]%></textarea>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0px;">
                          <select name="BLOQUE" style="width: 400px;" class="form-control" style="padding-left: 0px;" required>
        	                ...
        	                while(rsGetEmpresa.next()){
        	                	if(rsGetEmpresa.getString("id").equals(lstEvento[2])){
        	                	%>
