<%@page import="com.movemini.simpleajaxservlet.reports.Report2Form"%>
<%
	response.setHeader("Cache-Control", "no-cache"); //HTTP 1.1
	response.setHeader("Pragma", "no-cache"); //HTTP 1.0
	response.setDateHeader("Expires", 0); //prevents caching at the proxy server
%>
<%@page import="com.movemini.simpleajaxservlet.reports.Report1Form"%>

<%@page
	import="com.movemini.simpleajaxservlet.interprete.EspecialidadesAplicablesTable"%>
<%@page
	import="com.movemini.simpleajaxservlet.interprete.EspecialidadesInterpreteTable"%>
<%@page
	import="com.movemini.simpleajaxservlet.interprete.InterpreteForm"%>
<%@page
...
<%
	try {
		...
		Report2Form bean2 = new Report2Form(request);
...
<title>SAO - Reporte Interpretes</title>
...
<body class="nav-md">
	...
	<input type="hidden" id="id_interprete" value="<%=""%>">
				...
				<div class="">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<p>
									<strong>Datos del Int&eacute;rprete </strong>
								</p>
								...
								<div class="" role="tabpanel" data-example-id="togglable-tabs">
									<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
										<li role="presentation" class="active"><a
											...
											data-toggle="tab" aria-expanded="true">Totales Facturados</a>
										</li>
