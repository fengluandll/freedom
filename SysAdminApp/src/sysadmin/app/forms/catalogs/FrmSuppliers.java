...
import sysadmin.app.data.SupplierDAO;
import sysadmin.app.model.SupplierBean;
...
public class FrmSuppliers extends JInternalFrame {
	...
	private int glSupplierAct;
    private SupplierDAO dtData;
    private List<SupplierBean> listData;
    private int ginCountSuppliers = 0;
	...
	public FrmSuppliers() {
        ...
        btnFind.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Buscar.png")));
        ...
        btnFirst.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Primero.png")));
        ...
        btnForward.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Anterior.png")));
        ...
        btnNext.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Siguiente.png")));
        ...
        btnLast.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Ultimo.png")));
        ...
        btnNew.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Nuevo.png")));
        ...
        btnDelete.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Borrar2.png")));
        ...
        btnSave.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Guardar.png")));
        ...
        btnCancel.setIcon(new ImageIcon(FrmSuppliers.class.getResource("/images/Cancelar2.png")));
	...
	private void btnForwardActionPerformed(ActionEvent e){
        if(glSupplierAct == 0) return;
        glSupplierAct--;
        fnShowRow();
	}
	private void btnNextActionPerformed(ActionEvent e){
        if(glSupplierAct == ginCountSuppliers-1) return;
        glSupplierAct++;
        fnShowRow();
	}
	private void btnLastActionPerformed(ActionEvent e){
        glSupplierAct = ginCountSuppliers -1;
        fnShowRow();
	}
	...
	private void btnSaveActionPerformed(ActionEvent e){
        ...
        String lstMessage = "";
        int linExistSupplier;
        linExistSupplier = dtData.fnSupplierExist(txtRfc.getText()); 
        ...
        if(glIsNew == true && linExistSupplier != 0){
        ...
        if (glIsNew){
            ...
            lstMessage = dtData.fnInsertSupplier(txtFirstname.getText(), txtLastname.getText(), txtBusinessname.getText(), txtRfc.getText(), 
        	...
        	Date ldtEndDate = new java.sql.Date(dtcEnddate.getDate().getTime());
        	lstMessage = dtData.fnUpdateSupplier(listData.get(glSupplierAct).getVendor_id(), 
	...
	private void btnDeleteActionPerformed(ActionEvent e){
        ...
        String lstMessage = dtData.fnDeleteSupplier(String.valueOf(listData.get(glSupplierAct).getVendor_id()),String.valueOf(ginUserId));
        if(!lstMessage.equals("OK")){
    		lblMessage.setForeground(UIManager.getColor("Button.select"));
	...
	private void fnShowRow(){
		txtFirstname.setText(listData.get(glSupplierAct).getFirst_name());
		txtLastname.setText(listData.get(glSupplierAct).getLast_name());
		txtRfc.setText(listData.get(glSupplierAct).getRfc());
		txtBusinessname.setText(listData.get(glSupplierAct).getBusiness_name());
		txtAdressline1.setText(listData.get(glSupplierAct).getAddress_line1());
		txtAdressline2.setText(listData.get(glSupplierAct).getAddress_line2());
		txtAdressline3.setText(listData.get(glSupplierAct).getAddress_line3());
		txtCity.setText(listData.get(glSupplierAct).getCity());
		txtState.setText(listData.get(glSupplierAct).getState());
		txtCountry.setText(listData.get(glSupplierAct).getCountry());
		txtPostalcode.setText(listData.get(glSupplierAct).getPostal_code());
		txtPhone.setText(listData.get(glSupplierAct).getPhone());
		txtEmail.setText(listData.get(glSupplierAct).getEmail());
        dtcStartdate.setDate(listData.get(glSupplierAct).getStart_date());
        dtcEnddate.setDate(listData.get(glSupplierAct).getEnd_date());
    }
	private void fnLoadTable(String p_first_name, String p_last_name, String p_rfc, String p_business_name){
		...
		ginCountSuppliers = listData.size();
