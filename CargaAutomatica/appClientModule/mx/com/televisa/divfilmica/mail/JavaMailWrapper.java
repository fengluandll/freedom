...
static Logger logger = Logger.getLogger(JavaMailWrapper.class);
...
public void sendMail() throws Exception {        
    ...
    //                      mbp2.setFileName("Contrato.pdf");
                          
                          
                          //mail 1.4
                          /*Este if solo esta en harcode solo listo en caso de recibir dos archivos o zip
                          para adjuntarlo, porque originalmente solo se podia uno, si solo se adjunta uno
                        toma el else*/
                          ...
                          if(strFile.length == 2 ){
                              ...
                              mbp2.attachFile(new File(strFile[0]));
                              MimeMultipart mp = new MimeMultipart();
                              mp.addBodyPart(mbp1);
                              mp.addBodyPart(mbp2);
                              msg.setContent(mp);
